...
HD_PWD='C:/Users/gaherere/Desktop/derniereChance/netlist/ip_catalog/subsystem.runs/Subsystem_bd_Subsystem_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Subsystem_bd_Subsystem_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Subsystem_bd_Subsystem_1_0.tcl
